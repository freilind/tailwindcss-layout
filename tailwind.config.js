  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'text-banner': 'showBannerText 4s linear',
      ...
      keyframes: {
        ...
        backBanner: {
          ...
          '100%': { 'background-position': '-330px -200px' },
        },
        showBannerText: {
          ...
          '100%': { transform: 'translateX(0%) scale(5,5)', 'text-shadow': '2px 2px 1px black', color: 'white', opacity: 1 },
        },
        showCardIcon: {
